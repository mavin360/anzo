...
class PageSectionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'section_title' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'section_text' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'added_date' => '2017-10-31 10:49:19',
            'modify_date' => '2017-10-31 10:49:19'
        ],
    ];
}
