...
<div class="panel-body panel-body-nopadding">
 <?= $this->Form->create($gallery,['class'=>'form-horizontal form-bordered','enctype' => 'multipart/form-data']);
    ...
    <div class="form-group"><label class="col-sm-2 control-label">Image Description</label><?php echo $this->Form->control('gallery_desc',['class'=>'form-control','type'=>'textarea']);?></div>
	<div class="form-group"><label class="col-sm-2 control-label"> Image Status </label><?php echo $this->Form->radio('status',[['value'=>'active','text'=>'  Active'],['value'=>'inactive','text'=>'  Inactive']],['label' => ['style' =>'padding:10px']]);?></div>
