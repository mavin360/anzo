...
<div class="panel-body panel-body-nopadding">
 <?= $this->Form->create($item,['class'=>'form-horizontal form-bordered','enctype' => 'multipart/form-data']);
	...
	<div class="form-group"><label class="col-sm-2 control-label">Item Sub Category</label><?php echo $this->Form->control('sub_category_id', ['options' =>[''=>'Select Category'],'class'=>'form-control']);?></div>
	...
	<div class="form-group"><label class="col-sm-2 control-label"> Item Image </label> <?php echo $this->Form->control('product_image',['class'=>'form-control','type'=>'file']);?></div>
